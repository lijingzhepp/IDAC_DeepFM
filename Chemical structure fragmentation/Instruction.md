1. The chemical structure fragmentation of green solvents and solutes was under the environment that could be imported by "my-rdkit-env.yml". Please refer to the **Environment** folder.
